...
export const navigationCustomizations: Components<Theme> = {
    ...
    styleOverrides: {
      root: ({ theme }) => ({
        ...
        "&::before": {
          ...
          bottom: 0,
          left: 0,
          backgroundColor: ((theme as any).vars || theme).palette.text
            .secondary,
          opacity: 0.3,
  ...
  MuiPaginationItem: {
    styleOverrides: {
      root: ({ theme }) => ({
        "&.Mui-selected": {
          color: "white",
          backgroundColor: ((theme as any).vars || theme).palette.grey[900],
        },
        ...theme.applyStyles("dark", {
          "&.Mui-selected": {
            color: "black",
            backgroundColor: ((theme as any).vars || theme).palette.grey[50],
          },
        }),
      }),
    },
  ...
  MuiTabs: {
    styleOverrides: {
      ...
      indicator: ({ theme }) => ({
        backgroundColor: ((theme as any).vars || theme).palette.grey[800],
        ...theme.applyStyles("dark", {
          backgroundColor: ((theme as any).vars || theme).palette.grey[200],
        }),
      }),
    },
  },
  ...
  MuiStepIcon: {
    styleOverrides: {
      root: ({ theme }) => ({
        ...
        "&.Mui-completed": {
          border: "none",
          color: ((theme as any).vars || theme).palette.success.main,
        },
        ...theme.applyStyles("dark", {
          border: `1px solid ${gray[700]}`,
          "&.Mui-active": {
            border: "none",
            color: ((theme as any).vars || theme).palette.primary.light,
          },
          "&.Mui-completed": {
            border: "none",
            color: ((theme as any).vars || theme).palette.success.light,
          },
        }),
        variants: [
          {
