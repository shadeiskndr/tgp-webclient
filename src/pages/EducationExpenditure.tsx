...
export default function EducationExpenditure() {
  const {
    ...
    initialCountry: "MY",
    dataCategory: DataCategory.EDUCATION,
  });
          ...
          <Grid container spacing={0} columns={12} sx={{ mb: 4 }}>
            <Grid size={12}>
              <EconomicDataChart
                ...
                yAxisLabel="Education Expenditure (Total % of GDP)"
              />
            </Grid>
          </Grid>
          ...
          <Grid container spacing={0} columns={12}>
            <Grid size={12}>
              <EconomicDataTable
                ...
                title="Education Expenditure Details"
                valueLabel="Education Expenditure (Total % of GDP)"
              />
            </Grid>
          </Grid>
        </>
